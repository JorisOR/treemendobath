(function (root, factory) {
	...
	L.TileLayer.Provider.providers = {
		...
		MapBox: {
			url: '//api.tiles.mapbox.com/v4/mapbox.satellite/{z}/{x}/{y}.png?access_token=sk.eyJ1IjoidHJlZW1lbmRvIiwiYSI6ImNrZmU3YXVjbTAyNTIyeHczNGpnbmZoOW8ifQ.NH-gfMAiC8j6wzMYN1eOwQ',
			options: {
				attribution:
