    ...
    for (var i in points) {
      ...
      if (point.Latitude !== '' && point.Longitude !== '') {
        var marker = L.marker([point.Latitude, point.Longitude], {icon: icon})
          .bindPopup("<b>" + point['Name'] + '</b><br>' + 'Lat: ' + point['Latitude'] + '<br>' + 'Lon: ' + point['Longitude'] + '<br>' + 'ID: ' + point['ID'] + '<br>' +
		  '<a target="_blank" class="popup" href="' + point.Image + '">' +
        '<center><img src="' +point.Image + '" title="Click for the full picture" /></center><br> Click for the full picture</a>' +
          point['Description']
		  );
...
*/
   ...
   */
  function addBaseMap() {
    var basemap = trySetting('_tileProvider', 'Stamen.Terrain');
